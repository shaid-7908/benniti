...
class Users {
  ...
  public function createUser($data, $byAdmin) {
    ...
    if ($data['fullname'] == "" || $data['username'] == "" || $data['email'] == "" || $data['phone'] == "" || $data['password'] == "") {
      ...
      $sql = "INSERT INTO tbl_users(public_id, fullname, username, email, password, phone, roleid) 
        VALUES (:publicid, :fullname, :username, :email, :password, :phone, :roleid)";
      $stmt = $this->db->pdo->prepare($sql);
