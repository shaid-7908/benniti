      ...
      echo "
          ...
          <div class='form-group'>
            ...
            <div class='address-field'>
              ...
              <input type='text' name='address1' id='address1' value='{$opportunity['location']}' class='form-control' minlength='2' maxlength='254' style='background-color: white; border: 1px solid #ced4da;'>
              ...
              <input type='text' name='address2' id='address2' value='{$opportunity['location']}' class='form-control' minlength='2' maxlength='254' style='background-color: white; border: 1px solid #ced4da;'>
          ...
          <div class='form-group'>
            ...
            <div class='pay-rate'>
              ...
              <input type='text' name='rate-value' id='rate-value' value='{$opportunity['rate']}' class='form-control' minlength='3' maxlength='254' required style='background-color: white; border: 1px solid #ced4da;'>
            </div>
          </div>
