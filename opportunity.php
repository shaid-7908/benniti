...
<div class="xt-card-organization">
  ...
  <div class="xt-sidebar-organization p-4" >

    <div class="step-indicators" style="margin-top: 20px">
    ...
    <div style="width:600px; margin:0px auto">
      ...
      <form name="frmOpportunity" id="frmOpportunity" class="" action="" method="POST">
        ...
        <fieldset>
          ...
          <input type="button" name="previous" class="previous-form btn btn-info" value="Previous" style="background-color: #E7E7E8; border: none; width:130px;color:black;font-weight: 700;" />
          <button id="btnControlSubmit" class="btn btn-success" onclick="controlledFormSubmit('frmOpportunity')"><?php echo $buttonText; ?></button>
