...
<div class="xt-card-organization ">
  ...
  <div class="xt-sidebar-organization px-4" style="align-items: flex-start;">
    ...
    ?>
    <div class="step-indicators text-white my-4">
      <h1 style="font-size: 24px;font-weight: 700;">Lets get you set up</h1>
      <div class="step-indicators">

        <div class="step-indicator my-4 active">
          <div class="mr-1" style="width: 30px; height: 30px; border: 1px solid ; display: flex; justify-content: center; align-items: center; border-radius: 4px;">1</div>
          Organization details
        </div> <!-- Step 1 -->
        <div class="step-indicator my-4">
          <div class="mr-1" style="width: 30px; height: 30px; border: 1px solid ; display: flex; justify-content: center; align-items: center; border-radius: 4px;">2</div>
          Location
        </div> <!-- Step 2 -->
        <div class="step-indicator my-4">
          <div class="mr-1" style="width: 30px; height: 30px; border: 1px solid ; display: flex; justify-content: center; align-items: center; border-radius: 4px;">3</div> Contact Information
        </div> <!-- Step 3 -->
      </div>
    </div>
    <div class="bottom" style="margin-top: auto;color:#F5A800">

      <div class="my-2">Cancel</div>
...
<div style="display: flex;">
  <div style="flex:20%;background-color: #012B33;">
    <hr style="border-color: #F5A800;">
    <div class="my-2 px-4" style="color: #F5A800;">Bennit Ai</div>
  </div>
  <div style="flex:80%; background-color: white;"></div>
</div>
</body>
