...
<div class="xt-card-organization">
  ...
  <div class="xt-body-organization" style="background-color: #f3f3f3;">
        ...
        <div style="display: flex;position: relative;">
          <div style="flex:15%;display: flex;justify-content: center;">
            <div style="width: 124px; height: 124px;background-color: gray;transform: translateY(-20px);">
              <img src="https://img.freepik.com/free-vector/bird-colorful-gradient-design-vector_343694-2506.jpg" alt="Your Image" style="width: 100%; height: 100%; object-fit: cover;">
            </div>
          ...
          <div style="flex:60%;padding:8px;">
            ...
            <div class="my-4 pb-4" style="border-bottom: 1px solid #E7E7E8;">
...
<script>
  $(document).ready(function() {
    $('#matchForm').submit(function(event) {
      ...
      $.ajax({
        type: 'POST',
        url: 'fr_handle_match_by_seeker.php',
        data: formData,
