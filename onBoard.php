...
?>
                ...
                <div class=" card-onBoard">
                    ...
                    <div class="d-flex">
                        <div style="flex:1 ;text-align: left;">
                            <h3 style="font-size: 60px; font-weight: 700;line-height: 66px;">The <br> Manufacturing Exchange™</h3>
                        </div>
                        <div style="flex:1;display: flex; flex-direction: column;justify-content: end;">

                            <p style="font-weight: 400;font-size: 16px;line-height: 24px;">At Bennit, we believe that the key to manufacturing success lies in matching manufacturing challenges with the right subject matter experts, services, or products.

                            </p>
                            <p class="mt-2" style="font-weight: 400;font-size: 16px;line-height: 24px;">It is this principle that guided us in developing The Manufacturing Exchange, a dedicated platform where manufacturers or those facing manufacturing challenges can easily find and access the expertise they need.
                        ...
                        <div class="div" style="width:100%">
                            ...
                            <div class="">
                                <div class="d-flex " style=" width: 100%;">
                                    ...
                                    <div align="center" style="flex:1;height:45vh; border:2px solid #F5A800" class="onboard-choice-icon mr-1 my-2 p-4">
                                        <a href="?step=seeker" class="my-2">
                                            ...
                                            <h3 class="text-white" style="font-weight: 700;font-size: 24px;"><br />I'am a Seeker</h3>
                                    ...
                                    <div align="center" style="flex:1;height:45vh; border:2px solid #F5A800" class="onboard-choice-icon ml-1 my-2 p-4">
                                        <a href="?step=solver" class="my-2">
                                            ...
                                            <h3 class="text-white" style="font-weight: 700;font-size: 24px;"><br />I'am a Solver</h3>
    ...
    case "seeker": {
            ...
            Session::set("onboarding", $onboardingData);
        ?>
            <div style="height: 90vh;background-color: #012B33; width:100vw !important;display:flex;justify-content: center;align-items: center;">
                <div class="card-seeker-onboar" style="border-radius: 4px;background-color: #024552;width:800px">
                    <tr>
                        <td colspan="3">
                            <p class="text-center" style="font-weight: 400; font-size:16px;width:70%;">Bennit can help! We'll search our database for Solvers with the skills and expertise you need.</p>
                            <p class="text-center" style="font-weight: 400; font-size:16px;width:70%;">To get started, we'll define the Organization that you represent, so we can collect all the information necessary to match you with the best resources!</p>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
    ...
    case "solver": {
            ...
            Session::set("onboarding", $onboardingData);
        ?>
            <div class="" style="height: 90vh;background-color: #012B33; width:100vw !important;display:flex;justify-content: center;align-items: center;">
                    ...
                    <tr>
                        <td colspan="4">
                            <div style="display: flex; justify-content: center; align-items: center; flex-direction: column; padding: 15px 30px; margin-top: 10px;">
                                ...
                                <p style="text-align: center; font-size: 17px;">To get started, we need to connect you with an Organization that can receive payments and handle the necessary tax and legal documents.<br>
            ...
            <div style="display: flex; justify-content: center;align-items: center; width:100vw;background-color: #012B33;height:90vh">
                <div class="card-seeker-onboar-last">
                    <div style=" display: flex; flex-direction: column; justify-content: center; align-items: center;">
                        ...
                        <p style="width: 60%; text-align: center;">You're basic information is set-up, and you can start using the Exchange -- but you'll get out of it what you put into it, so don't stop now...</p>
