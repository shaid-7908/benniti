    ...
    <div class="modal-content"  style="border-radius: 4px;">
      ...
      <div class="modal-body" style="color: black;max-height: 400px; overflow-y: auto;">
       ...
       <div class="modal-footer" style="display: flex; justify-content: flex-start;">
         ...
         <a href="index.php">
          <div type="button" class="" style="background-color: #E7E7E8; border:none;color:black;border-radius: 4px;width:155px;height:40px;font-weight: 700;font-size: 14px;" data-dismiss="modal">Go to Dashboard</div>
         </a>
        </div>
    </div>
  </div>
...
<div class="xt-card-organization">
  ...
  <div class="xt-body-organization" style="color:black">
    ...
    <div>
      <div style="width:100%; margin:0px auto; border-bottom: 2px solid #E7E7E8;">
        <form class="" action="" method="GET" id="searchForm" style="display: flex;align-items: center; padding:10px ; justify-content: space-between;">
          <div style="font-size: 20px;font-weight: 700; color:black">Find Solvers</div>
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); grid-gap: 10px;padding: 10px; ">
      ...
      <!--- When query is null we will display Lates solvers --->
      <?php
      if ($theQuery == "") {
          if(empty($Solvers)){
      ?>
        <div class="inter-font font-700 font-34"  style="text-align: center;">
          No Solvers Found
        </div>
        ...
        foreach ($Solvers as $solver) :
          if ($solver->fk_user_id != $user_real_id) {
            $org = $organizations->getOrganizationInfoByRealId($solver->fk_org_id);
            ...
            <div class="card mt-2">
              <div class="card-body" style="color: black;">
                ...
                <div class="d-flex">
                  ...
                  <div class="ml-2">
                    <h1 style="color: #012B33; font-size: 20px; font-weight: 700;line-height: 28px;"><?php echo $org->orgname ?></h1>
                ...
                <div class="my-2 ">
                  <p class="truncated-text"><?php echo $solver->experience ?></p>
                 
                </div>
                <!-- Solver SKills -->
                <div class="d-flex my-2">
                  <?php
                  $all_skills = $skills->getAllSkillsForSolverById($solver->id);
                  foreach ($all_skills as $skill) :
                  ?>
                    <div style="background-color: #E7E7E8; padding: 4px 8px 4px 8px; border-radius: 4px;margin-right: 4px;font-size: 14px; font-weight: 400;"><?php echo $skill->skill_name ?></div>
                  <?php endforeach ?>
                </div>
                <!--Solver location -->
                <div class="d-flex my-2 " style="align-items: center;">
                  ...
                  <div class="ml-2" style="color: #012B33; font-size:14px; font-weight:600;"><?php echo $solver->locations ?></div>


                </div>
                <!--Action buttons -->
                <div class="my-4 d-flex">
                  <a href="viewSolver.php?public_solver_id=<?php echo $solver->public_id ?>">
                  ...
                  <div data-id="<?php echo $solver->id ?>" data-name="<?php echo $org->orgname ?>" class="ml-2 match" style="cursor: pointer; width: 74px;height: 40px;background-color: #E7E7E8;padding: 8px 12px 8px 12px;font-size: 16px; font-weight: 700;border-radius: 4px;">
                    Match
                  </div>
                </div>
              </div>
      ...
      <?php
          ...
          $Solvers = $solvers->searchSolvers($theQuery);
          foreach($Solvers as $solver):
      ?>
           <div class="card mt-2">
              <div class="card-body" style="color: black;">
